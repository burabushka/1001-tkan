...
## Правило
Если проблема найдена вне текущего тикета, не чинить ее сразу. Записать здесь и завести/уточнить тикет.

## Открытые проблемы

| ID | Область | Проблема | Где видно | Предлагаемый тикет | Статус |
|---|---|---|---|---|---|
| KI-001 | Design | В `index.html` используются Furniture-цвета `gold`, `violet`, `coral` как основная палитра | Tailwind config и классы в `index.html` | DES-001 | Open |
